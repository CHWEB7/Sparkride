        ...
        <aside className="hidden lg:block">
          ...
          >
            <div className="relative pl-6">
              <div
                aria-hidden
                className="absolute bottom-2 left-[7px] top-2 w-px bg-gray-200 dark:bg-white/10"
              />
              <motion.div
                aria-hidden
                className="absolute left-[7px] w-px origin-top bg-brand-gradient"
                initial={false}
                animate={{
                  height: reduceMotion
                    ? "100%"
                          ...
                          className={`text-sm leading-snug transition-colors ${
                            isActive
                              ...
                              : isPast
                                ...
                                : "text-muted group-hover:text-dark dark:group-hover:text-white"
                          }`}
                        >
                          {section.title}
                        </span>
                ...
                >
                  ...
                  <h2
                    className={`text-xl font-semibold tracking-[-0.02em] transition-colors sm:text-2xl ${
                      isActive ? "text-brand dark:text-brand-end" : "dark:text-white"
                    }`}
                  >
                    {section.title}
                  </h2>
