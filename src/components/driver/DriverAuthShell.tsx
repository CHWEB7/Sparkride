...
export const driverAuthInputClass =
  "w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-[15px] text-gray-900 placeholder:text-gray-400 outline-none transition-shadow focus:border-brand/40 focus:ring-2 focus:ring-brand/20 dark:border-white/10 dark:bg-white/5 dark:text-white dark:placeholder:text-gray-500";
  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-2">
      ...
      <div className="flex min-h-screen flex-col bg-white dark:bg-dark">
        ...
        <header className="flex items-center justify-end px-6 pt-6 lg:px-10">
          <ThemeToggle />
        </header>

        <div className="flex flex-1 items-center justify-center px-6 pb-10 pt-4 lg:px-12 lg:pb-16">
          <div className="w-full max-w-[420px]">
            <h2 className="text-3xl font-semibold tracking-[-0.02em] text-gray-900 dark:text-white">
              {title}
            </h2>
            {subtitle && (
